  ...
  return (
    <main className="min-h-screen bg-animated relative overflow-hidden">
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center p-8">
        ...
        <Link
          href="/"
          className="absolute top-8 left-8 glass-card px-4 py-2 text-white/80 hover:text-white transition-colors group"
        >
        ...
        <div className="max-w-md w-full fade-in">
          ...
          <div className="text-center mb-8">
            <div className="inline-block glass-card p-6 glow mb-6">
          ...
          <div className="glass-card space-y-6">
            ...
            <button
              ...
              className="w-full glass hover:scale-[1.02] transition-all duration-300 group relative overflow-hidden"
            >
              <div className="relative z-10 flex items-center justify-center gap-3 py-4 px-6">
                ...
                <span className="text-white font-semibold text-lg">Continuar con Google</span>
              </div>
